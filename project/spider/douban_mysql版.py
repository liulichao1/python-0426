# @Time : 2019/5/13 15:12
# @Author : 2273360936@qq.com
# @FileName : douban_mysql版.py
# @GitHub : https://github.com/liulichao1/python-0426
# activate  # 激活
# pip install mysql # 安装mysql     (mysqldb)
...
def initMySQL():
    ...
    psd = "chao0309@"
    db = "douban"
    db_conn = pymysql.connect(host=host, user=user, password=psd, db=db, charset="utf8")
